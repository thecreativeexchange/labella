...
void HlDraw::RenderCross( const MtVector3 &v3Position, MtMatrix4 &m4Transforn, BtFloat length, BtU32 sortOrder )
{
	MtMatrix3 m3Rotation = RsRenderTarget::GetCurrent()->GetCamera().GetRotation().GetInverse();
	...
	RenderArrow( v3Position - v3HalfAxisX, v3Position + v3HalfAxisX, v3AxisY, RsColour::RedColour(),   MaxSortOrders - 1);
	RenderArrow( v3Position - v3HalfAxisY, v3Position + v3HalfAxisY, v3AxisX, RsColour::GreenColour(), MaxSortOrders - 1);
	RenderArrow( v3Position - v3HalfAxisZ, v3Position + v3HalfAxisZ, v3AxisY, RsColour::BlueColour(),  MaxSortOrders - 1);
}

////////////////////////////////////////////////////////////////////////////////
// RenderQuad

void HlDraw::RenderQuad( const MtVector2 &v2Position, RsColour colour, BtU32 sortOrder )
{
