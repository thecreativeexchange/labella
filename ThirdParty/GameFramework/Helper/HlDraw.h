...
public:
	...
	static void							RenderCross( const MtVector3 &v3Position, MtMatrix4 &m4Transforn, BtFloat width = 0.5f, BtU32 sortOrder = MaxSortOrders - 1 );
    ...
    static void							RenderQuad( const MtVector2 &v2Position, RsColour colour, BtU32 sortOrder = MaxSortOrders - 1);
