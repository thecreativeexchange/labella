...
void RsFontGLES::FixPointers( BtU8 *pFileData, BaArchive *pArchive )
{
	// Set the file data
...
void RsFontGLES::SetNewLineRatio( BtFloat ratio )
{
	m_ratio = ratio;
}
...
// virtual
MtVector2 RsFontGLES::GetDimension( const BtChar* szText )
{
...
// virtual
void RsFontGLES::Render( const MtVector2& v2Position,
...
// virtual
MtVector2 RsFontGLES::Render( const MtVector2& v2StartPosition,
							  const RsColour &colour,
							  const BtChar* szText,
							  BtU32 sortOrder )
{
